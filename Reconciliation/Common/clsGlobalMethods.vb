...
Namespace Reconciliation
    ...
    Public Class clsGlobalMethods
        ...
        Public Function GetNextNumber(ByVal ObjectCode As String)
            Try
                If ObjectCode.ToString = "" Then Return ""
                strsql = "Select Top 1 ""NextNumber"" from NNM1 T0 join OFPR T1 on T0.""Indicator""=T1.""Indicator"" "
                strsql += vbCrLf + " where T0.""ObjectCode""='" & ObjectCode & "' and CURRENT_DATE between T1.""F_RefDate""  and T1.""T_RefDate"";"
        ...
        Public Sub Update_UserFormSettings_UDF(ByVal form As SAPbouiCOM.Form, ByVal FormID As String, ByVal UserCode As Integer, ByVal TPLId As Integer)
            Try
                ...
                If objaddon.HANA = True Then
                    strsql = objaddon.objglobalmethods.getSingleValue("Select count(*) from CPRF Where ""FormID""='" & FormID & "' and ""TPLId""=" & TPLId & "")
                    ...
                    strsql = objaddon.objglobalmethods.getSingleValue("Select count(*) from CPRF Where ""FormID""='" & FormID & "' and ""TPLId""=" & TPLId & " and ""VisInForm""='Y'")
